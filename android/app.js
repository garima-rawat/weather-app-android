...
app.get('/autoComplete/:val', async (req, res) => {
    const url = `https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${req.params.val}&types=(cities)&key=AIzaSyC8OFO3dO-5IvxA-LDxAWU4N_uYT_b9u2s`
...
app.get('/card/:lat/:long', async (req, res) => {
    ...
    const url2 = `https://api.tomorrow.io/v4/timelines?location=${req.params.lat},${req.params.long}&fields=temperature,weatherCode,pressureSeaLevel,windSpeed,humidity,visibility,cloudCover,precipitationProbability,uvIndex&timesteps=current&timezone=America/Los_Angeles&units=imperial&apikey=4g9eE1O6pkAlcQMxJswpBBd4ghxStIOe`
