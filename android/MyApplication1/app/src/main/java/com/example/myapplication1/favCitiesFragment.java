 ...
 * Use the {@link favCitiesFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class favCitiesFragment extends Fragment {
     ...
     * @return A new instance of fragment favCitiesFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static favCitiesFragment newInstance(String param1, String param2, String param3, String param4) {
        favCitiesFragment fragment = new favCitiesFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_fav_cities, container, false);

//        mtextView = view.findViewById(R.id.fragment_name);
//        mtextView.setText("Hello " + mParam1 + " kl "+ mParam2 + " ls " +mParam3 +" sd "+ mParam4);
        ...
        deleteButton = (FloatingActionButton) view.findViewById(R.id.fab);
        deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getContext(),locationName +" was removed from favorites",Toast.LENGTH_SHORT).show();
    ...
    public void removefromFav(){
        ...
        try{
            store_val.put("City",locationName);
        ...
        ((Favourites)getActivity()).FavoriteAdapter.notifyChangeInPosition(Integer.valueOf(mParam4));
    }
